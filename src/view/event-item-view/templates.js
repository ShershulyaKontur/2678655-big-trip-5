...
import { getDuration, humanizePointDueDate } from '../../utils/formatter';

export function createEventItemsTemplate({type, dateFrom, dateTo, basePrice, isFavorite, offers}, destination, allOffersByType) {
  ...
  const selectedOffers = allOffersByType.filter((offer) => offers.includes(offer.id));
